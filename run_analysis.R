...
## Step 0. Set variables to be used in script
featureselect <- "(mean|std)\\(\\)"
fileurl <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"

## Step 1. Download file from cloud location if required and unzip
...
##Step 3. Read in test data, reduce and add labels & subjects
...
##Step 4. Read in training data, reduce and add labels & subjects
...
##Step 5. Merge test & train data, name activities, gather in to long format
